...
<head>
	...
	<title>Eliminar cliente TEC Eats</title>
...
<body class="container">
	<div class="container mt-5 "  align="center">
		<h1>Eliminar cliente TEC Eats</h1>
		<form action="EliminarCliente.php" method="POST">
			...
			<button type="submit" class="btn btn-light mt-5" name="eliminar_cliente" > <h2>Eliminar</h2> </button>
			<!-- href="../index.html" -->
