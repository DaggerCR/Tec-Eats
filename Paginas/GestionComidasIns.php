...
<head>
	...
	<title>Insertar comida TEC Eats</title>
...
<body class="container">
	<div class="container mt-5 "  align="center">
		<h1>Insertar comida TEC Eats</h1>
		<form action="InsertarComida.php" method="POST">
			...
			<button type="submit" class="btn btn-light mt-5" name="insertar_comida" > <h2>Agregar</h2> </button>
			<!-- href="../index.html" -->
