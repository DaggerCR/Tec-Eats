...
<body class="container">
	...
	<div class="container mt-5 "  align="center" >
		...
		<select class="form-select" aria-label="Default select example" id="PlatoPrincipal" name="PlatoPrincipal">
			...
			<?php
				$query = "SELECT * FROM comidas WHERE tipo_id= 1 and tiempo_id = 2";
		...
		<?php
            $query = "SELECT * FROM comidas WHERE tipo_id= 2 and tiempo_id = 2";
			$query_run = mysqli_query($con, $query);
		...
		<?php
            $query = "SELECT * FROM comidas WHERE tipo_id= 3 and tiempo_id = 2";
			$query_run = mysqli_query($con, $query);
		...
		<?php
            $query = "SELECT * FROM comidas WHERE tipo_id= 4 and tiempo_id = 2";
			$query_run = mysqli_query($con, $query);
